const initialState={
    ...
    Organisation:[{id:Math.random()*1000,company:["Select","Apple","Oneplus"] },
    {id:Math.random()*1000,company:["Select","Apple","Oneplus"] },
    {id:Math.random()*1000,company:["Select","Apple","Oneplus"]}],
    // Organisation:[{id:Math.random()*1000,company:["Apple","Oneplus"] },
    // {id:Math.random()*1000,company:["Apple","Oneplus"]}],
    // vendor:[{id:Math.random()*1000, firm:["Apple","OnePlus"],Apple:["Iphone 12 Pro Max","Iphone 12 Pro","Iphone 12","Iphone 12 Mini"],Oneplus:["OnePlus Nord 5G","OnePlus 5","OnePlus 6","OnePlus 7T"],Nokia:["Nokia 255 4G","Nokia 215 4G","Nokia C3","Nokia 701"],Samsung:["Samsung Galaxy M21","Samsung Galaxy M31","Samsung Galaxy M51","Samsung Galaxy S20"]}],
    Apple:["Iphone 12 Pro Max","Iphone 12 Pro","Iphone 12","Iphone 12 Mini"],
    Oneplus:["OnePlus Nord 5G","OnePlus 5","OnePlus 6","OnePlus 7T"],
    vendor:[{id:Math.random()*100000,firm:"Apple",Ordered:11,Apple:["Iphone 12 Pro Max","Iphone 12 Pro","Iphone 12","Iphone 12 Mini"]},
    {id:Math.random()*100000,Ordered:11,firm:"OnePlus",Apple:["Iphone 12 Pro Max","Iphone 12 Pro","Iphone 12","Iphone 12 Mini"],
    Oneplus:["OnePlus Nord 5G","OnePlus 5","OnePlus 6","OnePlus 7T"]}],
