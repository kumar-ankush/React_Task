const initialState={
    //For the items Needed page
    user:{},
    orderStatus:false,
    purchaseStatus:false,
    //Items needed page State End
    row:[{id:Math.random()*1000000000, itemName:"",
    heading:[{name:"Select",cost:0},{name:"Iphone 12 Pro",cost:119990},{name:"Iphone 12",cost:79900},
    {name:"Iphone 12 Pro Max ",cost:129900} ,{name:"Iphone 11 pro max",cost:108609},{name:"Iphone 11",cost:50999}], 
    price:"",quantity:"",discount:"",InStock:""}],
...
const reducer=(state=initialState,action)=>{
    ...
    if(action.type==="stateTransfer"){
       ...
       var orderStatus=true;
        ...
        else if(action.type==="ItemsContainer"){
            var vendor=[...action.value]
           var purchaseStatus=true
            return{
                ...state,
                vendor:[...vendor],
